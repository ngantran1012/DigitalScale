...
#define MQTT_TOPIC_TURN             "Turn"
#define MQTT_TOPIC_WEIGHT           "Weight"
#define MQTT_TOPIC_ID               "ID"

//------------------------------------------------------------------------------
// Use I2C to UART bridge module
//------------------------------------------------------------------------------
#ifdef I2C_UART_BRIDGE
#define UART_PORT              i2cuart      // This port is provided from SC16IS750 module     
#else
#define UART_PORT              SUART        // This port is provided from SoftwareSerial library
#endif
...
#ifndef ADMIN_PASS
#define ADMIN_PASS              "vietucnhamat"     // Default password (WEB, OTA, WIFI SoftAP)
#endif
...
#ifndef WEB_USERNAME
#define WEB_USERNAME                "vietuc"     // HTTP username
#endif
...
#ifndef MQTT_SERVER
#define MQTT_SERVER                 "113.161.218.67"              // Default MQTT broker address
#endif

#ifndef MQTT_USER
#define MQTT_USER                   "mqtt"              // Default MQTT broker usename
#endif

#ifndef MQTT_PASS
#define MQTT_PASS                   "vietucnhamat"              // Default MQTT broker password
#endif
...
#ifndef MQTT_TOPIC
#define MQTT_TOPIC                  "DigitalScale"    // Default MQTT base topic
#endif
...
#define MQTT_USE_JSON               1               // Don't group messages in a JSON body by default
#endif
...
#define MQTT_QUEUE_MAX_SIZE         40              // Size of the MQTT queue when MQTT_USE_JSON is enabled
#endif
...
#define MQTT_TOPIC_JSON             "HeartBeat"
...
#ifndef NTP_TIMEZONE
#define NTP_TIMEZONE                TZ_Asia_Ho_Chi_Minh      // POSIX TZ variable. Default to UTC from TZ.h (which is PSTR("UTC0"))
...
#define NTP_TIME_OFFSET             420              // Default timezone offset (GMT+1)
#endif
